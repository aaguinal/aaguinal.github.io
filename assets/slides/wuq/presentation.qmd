...
::: {.column width="40%"}
![](assets/quartologo.png){fig-align="center"}
[https://quarto.org/](https://quarto.org/)

- Create reproducible slides with dynamic content
- Supports Python, Julia, R execution env
- Can host on server and accessed remotely
- Uses enriched Markdown language
:::
